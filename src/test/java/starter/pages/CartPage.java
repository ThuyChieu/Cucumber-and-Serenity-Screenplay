...
public class CartPage {
    public static Target BTN_CHECK_OUT = Target.the("Check out product in cart").locatedBy("//div[contains(@class,'CartItems_CartBoxRight')]/button[contains(@class,'CartItems_PlaceOrder')]");
